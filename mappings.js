  ...
  "midi": {
    "LPD8": {
      "noteon": {
        ...
        "48": oscMapToConstTarget('/ch/05/mix/on', 127),
        "47": oscMapToConstTarget('/bus/1/mix/on', 127),
        "49": oscMapToConstTarget('/ch/06/mix/on', 127)
      },
      "noteoff": {
        ...
        "48": oscMapToConstTarget('/ch/05/mix/on', 0),
        "47": oscMapToConstTarget('/bus/1/mix/on', 0),
        "49": oscMapToConstTarget('/ch/06/mix/on', 0)
      }
//       ,
//       "cc": {
...
//       }
  ...
  "osc": {
    ...
    "/ch/05/mix/on": [ midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(50, 0, 0, 127)), blink("/ch/05/mix/on", midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(66, 0, 127))), midiSendNoteOn("LPD8", oscToMidiNoteOnCommandFactory(48)), mqttPublish('/ch/05/mix/on') ],
    "/ch/06/mix/on": [ midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(51, 0, 0, 127)), blink("/ch/06/mix/on", midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(67, 0, 127))), midiSendNoteOn("LPD8", oscToMidiNoteOnCommandFactory(49)), mqttPublish('/ch/06/mix/on') ],
    ...
    "/bus/1/mix/on": [ midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(55, 0, 0, 127)), blink("/bus/1/mix/on", midiSendCc("nanoKONTROL2", oscToMidiCcCommandFactory(71, 0, 127))), midiSendNoteOn("LPD8", oscToMidiNoteOnCommandFactory(47)), mqttPublish('/bus/1/mix/on') ],
    // SOLO handlers
